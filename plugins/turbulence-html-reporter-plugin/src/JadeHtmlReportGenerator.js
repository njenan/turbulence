...
var JadeHtmlReportGenerator = (function () {
    function JadeHtmlReportGenerator(fileWriter) {
        this.fs = fileWriter;
    ...
    JadeHtmlReportGenerator.prototype.toReport = function (results) {
    ...
    return JadeHtmlReportGenerator;
}());
exports.JadeHtmlReportGenerator = JadeHtmlReportGenerator;
