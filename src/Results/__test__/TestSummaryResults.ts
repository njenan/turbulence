...
describe('Summary Results', () => {
    describe('averageResponseTime', () => {
        it('should return the average all requests', () => {
            ...
            results.requests.push(new HttpRequestRecord(new HttpGetStep(undefined, undefined, undefined, undefined, undefined), new HttpResponse(), 1, 0));
            results.requests.push(new HttpRequestRecord(new HttpGetStep(undefined, undefined, undefined, undefined, undefined), new HttpResponse(), 2, 0));
            results.requests.push(new HttpRequestRecord(new HttpGetStep(undefined, undefined, undefined, undefined, undefined), new HttpResponse(), 3, 0));
        ...
        it('should return the average response for a specific url', () => {
            var results = new SummaryResults();
            results.requests.push(new HttpRequestRecord(new HttpGetStep(undefined, undefined, undefined, 'http://localhost:8080/a', undefined), new HttpResponse(), 10, 0));
            results.requests.push(new HttpRequestRecord(new HttpGetStep(undefined, undefined, undefined, 'http://localhost:8080/a', undefined), new HttpResponse(), 30, 0));
            results.requests.push(new HttpRequestRecord(new HttpGetStep(undefined, undefined, undefined, 'http://localhost:8080/b', undefined), new HttpResponse(), 1000, 0));
    ...
    describe('requestMap', () => {
        it('should return a map of each url with response times', () => {
            ...
            results.requests.push(new HttpRequestRecord(new HttpGetStep(undefined, undefined, undefined, 'http://localhost:8080/a', undefined), new HttpResponse(), 30, 0));
            results.requests.push(new HttpRequestRecord(new HttpGetStep(undefined, undefined, undefined, 'http://localhost:8080/b', undefined), new HttpResponse(), 1000, 0));
            results.requests.push(new HttpRequestRecord(new HttpGetStep(undefined, undefined, undefined, 'http://localhost:8080/b', undefined), new HttpResponse(), 3000, 0));
            results.requests.push(new HttpRequestRecord(new HttpGetStep(undefined, undefined, undefined, 'http://localhost:8080/c', undefined), new HttpResponse(), 10000, 0));
